...
public class SwiftDate {
	...
	public int getCentury() {
		return Integer.parseInt(Integer.toString(this.getYear()).substring(0, 2))+1;
	}
	public int getDaysDifference(SwiftDate other){
		...
		if(other.getMonth()==1||other.getMonth()==3||other.getMonth()==7||other.getMonth()==8||other.getMonth()==10||other.getMonth()==12){
			sMonth = 31;
		}else if(other.getMonth()==4||other.getMonth()==6||other.getMonth()==9||other.getMonth()==11){
			sMonth =30;
	...
	public void printInfo(){
		if(this.isLeapYear()==true){
			System.out.printf("%d 0%d %d %d century.It's leap year%n",this.getYear(),this.getMonth(),this.getDay(),this.getCentury());
		}else{
			System.out.printf("%d 0%d %d %d century.%n",this.getYear(),this.getMonth(),this.getDay(),this.getCentury());
		}
	}
}
