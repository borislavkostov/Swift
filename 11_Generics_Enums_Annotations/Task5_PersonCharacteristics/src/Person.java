...
public class Person {
	...
	private EducationDegree educationCode;
	private Address address;
	private List<Address> pastAddress;

	public Person(String fName, String middleName, String lName, Gender gender, String yearOfBorn, int heigh,
	...
	public EducationDegree getEducationCode() {
		return educationCode;
	}

	public void setEducationCode(EducationDegree educationCode) {	
